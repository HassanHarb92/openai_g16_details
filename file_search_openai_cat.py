...
#  instructions="You are an expert electrochemist. You provide well constructed scientific paragraphs on a given topic. Your expertise is in iron redox chemistry", # improve this instruction, add more details on chemistry
  instructions="You are an expert chemist who specializes in foundation models for catalysis. You will be given questions and you will answer them from your expertise and from the pdf documents provided.",
  model="gpt-4o",
...
file_paths = [os.path.join(directory, file) for file in os.listdir(directory) if file.endswith(".pdf")]

# Open the PDF files
file_streams = [open(path, "rb") for path in file_paths]

# Example usage
print(file_paths)  # This will print the list of PDF file paths
